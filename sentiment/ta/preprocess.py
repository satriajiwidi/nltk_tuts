...
def get_kamus():
    with open('indonesian_word_list.txt', 'r') as file:
        kamus = file.read()
...
def get_normalized_data(raw_data):
    ...
    if isfile('data_traveloka_normalized.pkl') and isfile('kamus_hasil.pkl'):
        with open('data_traveloka_normalized.pkl', 'rb') as data:
        ...
        with open('data_traveloka_normalized.pkl', 'wb') as data:
            pickle.dump([pos_texts_normalized, neg_texts_normalized], data)

        with open('kamus_hasil.pkl', 'wb') as data:
